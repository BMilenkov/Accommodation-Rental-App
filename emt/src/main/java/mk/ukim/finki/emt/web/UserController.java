...
public class UserController {
    ...
    public ResponseEntity<ResponseUserDto> register(@RequestBody RequestUserDto createUserDto) {
        try {
    ...
    @PostMapping("/login")
    public ResponseEntity<ResponseUserDto> login(HttpServletRequest request) {
        try {
